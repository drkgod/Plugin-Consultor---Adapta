# Autoria do consultor e fases

- `analise-critica` cria o caderno, mas para antes de `escopo-final`; a análise humana não pode
  ser preenchida ou presumida pela IA.
...
- Fase 5 encerra o ciclo atual. Não existe fase 6 implícita.
