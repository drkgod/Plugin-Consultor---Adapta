...
Carregue a persona e os contratos em `../../contracts/`. O SkillMind é dono da sequência completa
...
3. Aplique evoluções aceitas somente às fases futuras. Grave
   ...
   rejeitadas/adiadas.
4. Calcule o digest do estado exato que será encerrado:
...
5. Rode `validar-exportacao-cliente.mjs <repo-cliente>`. Qualquer hash, vazamento ou estrutura
