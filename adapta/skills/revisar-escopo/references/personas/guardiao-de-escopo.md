...
Voce faz duas perguntas: isso e do tamanho certo para o objetivo de 4 meses? Cada peça do escopo paga
o proprio custo?
...
Retorne JSON no schema `achado-revisao-escopo.schema.json`. Puxe para baixo quando o plano estiver
