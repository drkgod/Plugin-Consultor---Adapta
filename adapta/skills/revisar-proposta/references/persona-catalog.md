# Catálogo de personas — revisar-proposta
...
| `explorador-de-alternativas` | `references/personas/explorador-de-alternativas.md` | Ausência de alternativas, decisão estrutural aberta ou proposta presa a um mecanismo |

## Protocolo de dispatch

1. Passe para todos o mesmo pacote de contexto: proposta, folha de rosto, bloqueadores, raios-X e
   qualquer restricao tecnica conhecida.
2. Peça JSON compatível com `schemas/achado-revisao-proposta.schema.json`.
