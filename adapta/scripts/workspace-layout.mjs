...
export const PLAN_PATHS = Object.freeze({
  ...
  ethosSetup: path.join("03-Projeto", "03-Setup-Ethos"),
  ethosSetupIndex: path.join("03-Projeto", "03-Setup-Ethos", "00-INDICE.md"),
  ethosSoul: path.join("03-Projeto", "03-Setup-Ethos", "SOUL.md"),
  ethosIdentity: path.join("03-Projeto", "03-Setup-Ethos", "IDENTITY.md"),
  ethosUser: path.join("03-Projeto", "03-Setup-Ethos", "USER.md"),
  ethosConnectorSuggestions: path.join("03-Projeto", "03-Setup-Ethos", "sugestoes-conectores-automacoes.md"),
  ethosAgentLoopMap: path.join("03-Projeto", "03-Setup-Ethos", "mapa-de-agentes-e-loops.md"),
  ethosLoops: path.join("03-Projeto", "03-Setup-Ethos", "loops"),
